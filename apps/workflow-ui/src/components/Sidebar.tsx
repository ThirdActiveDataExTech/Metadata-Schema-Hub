  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="nav-section">
        ...
        <ul className="nav-list">
          <li>
            <NavLink to="/admin/upload" className={({ isActive }) => isActive ? 'nav-link active' : 'nav-link'}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          ...
          <li>
            <NavLink to="/admin/runs" className={({ isActive }) => isActive ? 'nav-link active' : 'nav-link'}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          ...
          <li>
            <NavLink to="/admin/drafts" className={({ isActive }) => isActive ? 'nav-link active' : 'nav-link'}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
